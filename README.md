...
The accessibility was solved by adding "alt" attributes to all images on the landing page.  We were able to increase their SEO by adding a title to the head.  Finally, by removing all div elements in the index.html page, applying a semantic structure, and consolidating the css page - we were able to provide better readability and ease the customization for future programming on their website.
